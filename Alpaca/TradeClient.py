...
class TradeClient:
    ...
    def get_all_assets(self):
        ...
        try:
            ...
            print(Fore.LIGHTWHITE_EX + f"💬 Total Available Assets: {len(assets)}")
        except Exception as e:
    ...
    def get_active_trades_for_asset(self, symbol):
        ...
        if isinstance(active_trades, str) and (
            ...
            print(Fore.YELLOW + f"🟠 No active trades found for asset: {symbol}")
            ...
            print(
                Fore.LIGHTWHITE_EX
                + f"💬 Total Active Trades for '{symbol}': {len(active_trades)}"
            )
            return active_trades

    def __initialize(self):
        print(Fore.LIGHTWHITE_EX + "⏳ Initializing Trading Client...")
        try:
            ...
            print(
                Fore.GREEN + "🟢 Successfully connected to Trading Client.",
                account.status,
            )
            return
        except Exception as e:
            print(Fore.RED + "🔴 Unable to establish connection to Alpaca Client.")
